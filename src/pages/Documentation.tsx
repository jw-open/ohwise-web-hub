  ...
  const articles: Record<string, React.ReactNode> = {
    "introduction": (
      <div>
        ...
        <ul>
          <li><strong>ai-relay</strong>: Open-source Python package (v0.4.45) that bridges AI coding agent CLIs to the OhWise web interface via real-time streaming</li>
